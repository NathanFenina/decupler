...
_D = {
 ...
 "messagerie-google": '<path d="M20 13a3 3 0 0 1-3 3H9l-4 3v-3.5A3 3 0 0 1 4 13V7a3 3 0 0 1 3-3h10a3 3 0 0 1 3 3Z"/><path d="M8.5 8.5h7M8.5 11.5h4"/>',
 "estimation-en-ligne": '<rect x="4" y="2.5" width="16" height="19" rx="2.5"/><path d="M7.5 6.5h9"/><path d="M8 11h.01M12 11h.01M16 11h.01M8 14.5h.01M12 14.5h.01M16 14.5h4"/><path d="M8 18h4"/>',
 ...
 "relance-facture":   '<path d="M6 2.5h9l3.5 3.5V21l-2.2-1.4L14 21l-2.3-1.4L9.4 21 7.2 19.6 5 21V4a1.5 1.5 0 0 1 1-1.5Z"/><path d="M14 2.5v4h4"/><path d="M8.5 10h7M8.5 13.5h5"/>',
 ...
 "parrainage":        '<circle cx="8.5" cy="8" r="3"/><path d="M3 20a5.5 5.5 0 0 1 11 0"/><path d="M16 7.5a3 3 0 0 1 0 6"/><path d="M18.5 10.5h4M20.5 8.5v4"/>',
