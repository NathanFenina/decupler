...
AGENTS = [
 ...
 ("posts-google", "Posts Google automatiques", "trouve",
  "Vous envoyez une photo de chantier par SMS. Le post part sur votre fiche, rédigé et optimisé.",
 ...
 ("sms-appel-manque", "SMS sur appel manqué", "capte",
  "Vous ne décrochez pas&nbsp;? Le client reçoit un SMS dans la seconde, à votre nom.",
 ...
 ("sms-formulaire", "SMS instantané sur formulaire", "capte",
  "Quelqu'un remplit une demande&nbsp;: vous êtes prévenu par SMS, lui aussi.",
 ...
 ("chatbot", "Assistant de chat sur le site", "capte",
  "Un visiteur a une question à 21&nbsp;h. Il obtient une réponse, pas une page de contact.",
 ...
 ("agent-vocal", "Agent vocal hors horaires", "capte",
  "Le téléphone sonne le samedi. Une voix répond, comprend le besoin et propose un créneau.",
 ...
 ("relance-devis", "Relance de devis sans réponse", "transforme",
  "Vos devis sans réponse sont relancés à J+3 et J+7, automatiquement et poliment.",
 ...
 ("reactivation", "Réactivation des clients dormants", "transforme",
  "Vos clients d'il y a deux ans reçoivent un message. Certains ont un nouveau projet.",
 ...
 ("demande-avis", "Demande d'avis Google", "capitalise",
  "Chaque client satisfait reçoit une demande d'avis, au bon moment, en un clic.",
 ...
 ("rapport-mensuel", "Rapport mensuel de l'argent récupéré", "pilote",
  "Chaque mois, le compte exact de ce que le système vous a rapporté.",
