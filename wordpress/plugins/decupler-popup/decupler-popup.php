...
+'#dcp-pop .dcp-go{display:flex;align-items:center;justify-content:center;width:100%;padding:13px 20px;border-radius:12px;background:linear-gradient(135deg,#4f46e5,#7c3aed);color:#fff!important;font-size:16px;font-weight:700;text-decoration:none!important;transition:transform .15s,box-shadow .15s}'
+'#dcp-pop .dcp-go:hover{transform:translateY(-1px);box-shadow:0 8px 22px rgba(79,70,229,.35)}'
+'#dcp-pop .dcp-no{display:block;margin:12px auto 0;padding:4px;background:none;border:0;color:#666687;font:inherit;font-size:13px;text-decoration:underline;cursor:pointer}'
+'#dcp-pop .dcp-close{position:absolute;top:10px;right:10px;width:36px;height:36px;border:0;border-radius:50%;background:rgba(255,255,255,.92);color:#1a1a2e;font-size:22px;line-height:1;cursor:pointer;box-shadow:0 2px 8px rgba(0,0,0,.12)}'
